...
#
# Created: Fri Aug 11 12:05:14 2017
...
class Ui_ImageFormatDialogBase(object):
    def setupUi(self, ImageFormatDialogBase):
        ...
        ImageFormatDialogBase.resize(445, 625)
        self.groupBox = QtGui.QGroupBox(ImageFormatDialogBase)
        self.groupBox.setGeometry(QtCore.QRect(20, 280, 401, 151))
        self.groupBox.setObjectName(_fromUtf8("groupBox"))
        self.layoutWidget = QtGui.QWidget(self.groupBox)
        self.layoutWidget.setGeometry(QtCore.QRect(20, 20, 356, 111))
        ...
        self.button_box_execute.setGeometry(QtCore.QRect(50, 570, 341, 32))
        ...
        self.checkBox_openwin.setGeometry(QtCore.QRect(30, 540, 191, 17))
        self.checkBox_openwin.setObjectName(_fromUtf8("checkBox_openwin"))
        self.label = QtGui.QLabel(ImageFormatDialogBase)
        self.label.setGeometry(QtCore.QRect(10, 200, 421, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.label.setFont(font)
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName(_fromUtf8("label"))
        self.pushButton_gdal = QtGui.QPushButton(ImageFormatDialogBase)
        self.pushButton_gdal.setGeometry(QtCore.QRect(190, 240, 31, 21))
    ...
    def retranslateUi(self, ImageFormatDialogBase):
        ...
        self.label.setText(_translate("ImageFormatDialogBase", "Path to gdal_translate - Ex:(C:\\OSGeo4W64\\bin)", None))
        self.pushButton_gdal.setText(_translate("ImageFormatDialogBase", "...", None))
